...
class Dubai(Base):
    ...
    transaction_date = Column(Integer, nullable=True)
    ...
    adeption_date = Column(Integer, nullable=True)
    ...
    inspection_date = Column(Integer, nullable=True)
    ...
    registration_date = Column(Integer, nullable=True)
    ...
    license_lssue_date = Column(Integer, nullable=True)
    license_expiry_date = Column(Integer, nullable=True)
    chamber_commerce = Column(Text, nullable=True)
    _tid = Column(String(255), nullable=False)
