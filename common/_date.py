...
def get_all_month_(dt: typing.Union[date, str], df: typing.Union[date, str], date_format='%m/%d/%Y', date_result='%d-%m-%Y'):
    """
    获取从指定时间开始到现在的所有月份
    日期从每个月1号开始计算
    """
...
def get_all_month(dt: typing.Union[date, str], df: typing.Union[date, str], date_format='%d/%m/%Y',date_result='%d-%m-%Y'):
    """
    获取从指定时间开始到现在的所有月份
    日期从每个月1号开始计算
    """
...
if __name__ == '__main__':
    all_month_start = get_all_month('01/03/2024')
    # all_month_end = get_last_days('2024-03-20')
